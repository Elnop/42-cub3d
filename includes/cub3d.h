...
/*   Updated: 2023/12/18 13:54:32 by lperroti         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_ray			get_first_wall(t_app *papp, t_coo o, double angle);
...
void			draw_rect(t_image img, t_coo s, t_coo lengths, int color);
bool			init_player(t_app *papp);
t_array			ray_cast(t_app *papp);
t_coo			lines_intersection(t_coo l1p1, t_coo l1p2, \
					t_coo l2p1, t_coo l2p2);
#endif